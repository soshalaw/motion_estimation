...
public:
    ...
    cv::Mat slice(cv::Mat M, std::array<double,3> &c, double theta_min_deg, double theta_max_deg, double alpha_min_deg, double alpha_max_deg, double xc, double yc, double c_, double d, double e, std::vector<double> invpol);
